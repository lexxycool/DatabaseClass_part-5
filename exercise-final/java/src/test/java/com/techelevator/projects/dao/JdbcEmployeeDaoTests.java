...
public class JdbcEmployeeDaoTests extends EmployeeProjectsDaoTests {
    ...
    public void getEmployeesWithoutProjects_finds_all_employees_not_assigned_to_projects() {
        ...
        Assert.assertEquals("getEmployeesWithoutProjects returned the wrong number of employees without projects",
                1, employees.size());
        assertEmployeesMatch("getEmployeesWithoutProjects returned wrong or partial data", EMPLOYEE_1, employees.get(0));
    }
